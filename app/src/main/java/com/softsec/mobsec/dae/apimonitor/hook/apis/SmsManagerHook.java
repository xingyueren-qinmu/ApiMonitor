...
public class SmsManagerHook extends Hook {
	...
	public void initAllHooks(XC_LoadPackage.LoadPackageParam packageParam) {
		...
		MethodHookHandler.hookMethod(sendTextMessagemethod, new MethodHookCallBack() {
			@Override
		...
		MethodHookHandler.hookMethod(getAllMessagesFromIccmethod, new MethodHookCallBack() {
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				String[] callingInfo = getCallingInfo(param.method.getName());
				Logger logger = new Logger();
		...
		MethodHookHandler.hookMethod(sendDataMessagemethod, new MethodHookCallBack() {
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				String dstNumber = (String)param.args[0];
		...
		MethodHookHandler.hookMethod(sendMultipartTextMessagemethod, new MethodHookCallBack() {
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				String dstNumber = (String)param.args[0];
